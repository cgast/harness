/**
 * Harness Web Client - Renderer Application
 *
 * Adapted from the Electron desktop renderer to work as a standalone
 * web application. Uses HarnessWebTransport (REST + WebSocket) instead
 * of Electron IPC for all backend communication.
 */

import { initTransport } from "./transport.js";

// Initialize the transport layer — sets up window.harness
initTransport();

// The harness API type (shared with desktop)
...
window.harness.onEvent(({ event, data }: { event: string; data: any }) => {
...
// ═══════════════════════════════════════════════════════════
// Keyboard Shortcuts (replaces Electron menu actions)
// ═══════════════════════════════════════════════════════════
